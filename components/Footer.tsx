        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 border-b border-zinc-800 pb-16">
          ...
          <div className="md:col-span-4 lg:col-span-3">
            ...
            <ul className="space-y-4 text-sm font-medium text-zinc-300">
              <li>
                <a href="https://wa.me/+260975232473" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-[#00FF00] transition-colors group">
                  <span className="w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:border-[#00FF00] transition-colors">
              ...
              <li>
                <a href="tel:+260975232473" className="flex items-center gap-3 hover:text-[#00FF00] transition-colors group">
                  <span className="w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:border-[#00FF00] transition-colors">
              ...
              <li>
                <a href="mailto:zedtuneza@gmail.com" className="flex items-center gap-3 hover:text-[#00FF00] transition-colors group">
                  <span className="w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:border-[#00FF00] transition-colors">
